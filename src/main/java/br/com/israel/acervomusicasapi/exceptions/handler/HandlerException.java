package br.com.israel.acervomusicasapi.exceptions.handler;

import br.com.israel.acervomusicasapi.controller.response.Erro;
import br.com.israel.acervomusicasapi.controller.response.Resposta;
import br.com.israel.acervomusicasapi.exceptions.AcervoMusicaException;
...
public class HandlerException extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(AcervoMusicaException.class)
    public final ResponseEntity<Erro> handleAcervoMusicaException(Exception ex, WebRequest request) {
